...
public class Booking {
    public void bookingDao(int guest_id, int room_id, String checkin_date, int choice, Scanner sc) throws ClassNotFoundException, SQLException {
        ...
        switch(choice){
            case 1:
                query = "INSERT INTO bookings(guest_id,room_id,checkin_date) VALUES(?,?,?)";
            ...
            case 2:
                query = "UPDATE INTO bookings(checkout_date) WHERE booking_id = ?";
